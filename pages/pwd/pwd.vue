	...
	<view class="content pt-50">
		<view class="input-group f-16">
			<view class="input-row border">
				...
				<input class="phoneinput t-l" type="text" clearable focus v-model="phoneMumber" placeholder="请输入所绑定的手机号"></input>
				<view @click="sendMunber" class="c-theme mt-25 ml-40 f-12" style="width: 180rpx;">  <!-- 发送验证码 -->
					{{phonetext}}
				</view>
			</view>
			<view class="input-row border">
				<text class="title f-16">验证码：</text>
				<input class="phoneinput t-l" type="text" clearable focus v-model="code" placeholder="请输入获取的验证码"></input>
			</view>
			<view class="input-row border">
				<text class="title f-16">新密码：</text>
				<input class="phoneinput t-l" type="text" clearable focus v-model="newPwd" placeholder="请输入新密码"></input>
			</view>

		</view>
		<!-- 发送验证码 -->
		<view class="mt-50">
			<button @click="" class="bg-main c-white f-16">修改密码</button>
			<!-- <view>验证码为：{{code}}</view> -->
		</view>
